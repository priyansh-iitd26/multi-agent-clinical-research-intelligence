...
async def side_effect_node(state: GraphState) -> dict:
    """
    the Side Effect Checker Agent node - finds safety gaps between filings and papers
    ...
    try:
        ...
        system_prompt = f"""You are the Side Effect Checker Agent for this
...
"""
        ...
        await _episodic.save_episode(
            ...
            episodic_content=f"Task: {task}. Found {len(signals_found)} safety gap signals.",
